...
def main(): # funcao principal que implementa a interface de linha de comando    
    ...
    try:
        if args.method == 'rec': # metodo recursivo simples
            ...
            #se n for maior que 20, avisa que o metodo recursivo simples nao é recomendado
        ...
        print("erro: stack overflow. use um metodo nao-recursivo (--method dp)", file=sys.stderr)
        sys.exit(1)
